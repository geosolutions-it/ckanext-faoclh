...
Preview tools enable visualization of resource data or file contents such as tables, charts, etc. Most common preview tools do not require installation of external plugins but some do. To enable a preview tool in CKAN, add it using the `ckan.plugins` configuration key in `/etc/ckan/default/production.ini` as shown below:
```
ckan.plugins = [...] your_preview_tool [...]
```
The table below contains some common preview tools, their configuration name (name entered as value of `ckan.plugins` in `/etc/ckan/default/production.ini`) and a brief description about them:
| Preview Tool       | Configuaration Name     | Description     |
| :------------- | :----------: | -----------: |
|  [Text View](https://github.com/geosolutions-it/ckanext-faoclh/wiki/Enabling-Common-Resource-Preview-Tools#text-view) | text_view   | Displays files in XML, JSON, or plain text-based formats with the syntax highlighted.   |
| [Image View](https://github.com/geosolutions-it/ckanext-faoclh/wiki/Enabling-Common-Resource-Preview-Tools#image-view)   | image_view | Displays resource with common image formats such as PNG, JPEG, or GIF |
|  [Web Page View](https://github.com/geosolutions-it/ckanext-faoclh/wiki/Enabling-Common-Resource-Preview-Tools#web-page-view) | webpage_view   | Displays web page resources as `<iframe>` in a resource page. |
| [PDF View](https://github.com/geosolutions-it/ckanext-faoclh/wiki/Enabling-Common-Resource-Preview-Tools#pdf-view)   | pdf_view | Renders PDF resource in resource page and requires the installation of [ckanext-pdfview](https://github.com/ckan/ckanext-pdfview) to enable and may require the use of [Resource Proxy](https://github.com/geosolutions-it/ckanext-faoclh/wiki/Enabling-Common-Resource-Preview-Tools#resource-proxy) to view PDF resources external to the CKAN host |
|  [Data Explorer](https://github.com/geosolutions-it/ckanext-faoclh/wiki/Enabling-Common-Resource-Preview-Tools#data-explorer) | recline_view   | It allows querying, filtering, graphing, and mapping data from the [datastore](https://docs.ckan.org/en/2.8/maintaining/datastore.html). |
| [Datastore Grid](https://github.com/geosolutions-it/ckanext-faoclh/wiki/Enabling-Common-Resource-Preview-Tools#datastore-grid)   | recline_grid_view | Displays a filterable, sortable, table view of structured data. |
|  [Datastore Graph](https://github.com/geosolutions-it/ckanext-faoclh/wiki/Enabling-Common-Resource-Preview-Tools#datastore-graph) | recline_graph_view   | Allows creating graphs from data stored on the [datastore](https://docs.ckan.org/en/2.8/maintaining/datastore.html). |
| [Datastore Map](https://github.com/geosolutions-it/ckanext-faoclh/wiki/Enabling-Common-Resource-Preview-Tools#datastore-map)   | recline_map_view | Displays data stored on the [datastore](https://docs.ckan.org/en/2.8/maintaining/datastore.html) in an interactive map. |
|  [Resource Proxy](https://github.com/geosolutions-it/ckanext-faoclh/wiki/Enabling-Common-Resource-Preview-Tools#resource-proxy) | resource_proxy   | Allows accessing files/resources external to the current CKAN host. |


**Note**: Some plugins may require installation of external/third-party plugins to enable them.
